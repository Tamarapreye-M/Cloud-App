...
import supportBgImg from "../assets/support.jpg";
			...
			<div className="max-w-[1240px] mx-auto text-white relative">
				<div className="px-4 py-12">
					...
					<p className="py-4 text-3xl text-slate-300">
						...
						Praesentium distinctio vel quod tenetur, reprehenderit est cum
						consequatur adipisci earum necessitatibus laborum pariatur modi
						officiis nam, placeat temporibus, laudantium dolorem. Provident.
					</p>
				</div>
					...
					<div className="bg-white rounded-xl shadow-2xl">
						<div className="p-8">
							...
							<p className=" text-gray-600 text-xl">
								Lorem ipsum dolor sit amet consectetur adipisicing elit.
								Cupiditate earum consequuntur recusandae tenetur nisi
								consectetur ad adipisci eius accusamus debitis!
							</p>
						</div>
